...
async function testCreateReward(): Promise<void> {
  try {
    const rewardData = {
      userId: TEST_USER_ID,
...
async function testCreateRewardValidation(): Promise<void> {
  const testCases = [
    {
      name: 'Invalid UUID',
...
async function testGetTodayStocks(): Promise<void> {
  try {
...
async function testGetTodayStocksValidation(): Promise<void> {
  try {
...
async function testGetHistoricalInr(): Promise<void> {
  try {
...
async function testGetPortfolio(): Promise<void> {
  try {
...
async function testPrecisionHandling(): Promise<void> {
  try {
    const rewardData = {
      userId: TEST_USER_ID,
      stockSymbol: 'WIPRO',
...
async function testPrecisionValidation(): Promise<void> {
  try {
    const rewardData = {
      userId: TEST_USER_ID,
      stockSymbol: 'TITAN',
...
async function testStockPriceService(): Promise<void> {
  try {
